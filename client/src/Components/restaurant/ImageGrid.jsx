    ...
    return (
        <>
           ...
           <div className="hidden w-full h-80 md:flex gap-1">
                ...
                <div className="absolute inset-0 opacity-40 bg-black w-full h-full rounded-lg"/>
                <h4 className="absolute inset-y-2/4 z-20 w-full text-center text-white font-semibold">View Gallery</h4>
                </div>
                <div className="w-full h-full relative">
                <img src={props.images[4]} 
                    ...
                    className="w-full h-full object-cover rounded-lg"
                />
                <div className="absolute inset-0 opacity-80 bg-gray-400 w-full h-full rounded-lg"/>
                <div className="absolute flex flex-col items-center inset-y-1/4 z-20 w-full h-full text-center text-white font-semibold">
                    <div className="bg-black p-3 rounded-full bg-opacity-90">
                        <AiOutlineCamera />
                    </div>
                    <h4 className="">
                        Add Photos
